...
catch_r2_boosting = function(yt, h_max = 12, p_out=12, n_out_out=200,name = NULL, best=F,cv_folds, bctrl_out){
  ...
  if(best){
    ...
    linear_estimate = catch_r2_boosting(yt, h_max = 12, p_out=best$p_linear_estimate, 
                               n_out_out=n_out_out,name = paste(name,"linear_estimate", sep = ""), best=F,
                               cv_folds= cv_folds, bctrl=bctrl_out)
    best_linear = catch_r2_boosting(yt, h_max = 12, p_out=best$p_best_linear, n_out_out=n_out_out,name = paste(name,"best_linear", sep = ""), 
